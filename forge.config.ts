...
const config: ForgeConfig = {
  packagerConfig: {
    ...
    // the dev scheme is claimed by the per-worktree bundle
    // scripts/dev-electron.mts registers, so this prod entry is NOT
    // exercised by dev sign-in. Verify changes to it against a
    // packaged build.
