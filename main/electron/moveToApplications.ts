...
export async function offerMoveToApplications(): Promise<boolean> {
  ...
  // Written for every answer, including the failures below: whatever
  // happens, the user has now been asked, and each outcome leaves them
  // with something they can act on themselves.
