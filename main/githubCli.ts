...
export function clearHasGithubRemoteCache(cwd?: string): void {
  if (cwd) hasGithubRemoteCache.delete(cwd);
  else hasGithubRemoteCache.clear();
}
...
async function ghReadyForRepo(cwd: string): Promise<boolean> {
