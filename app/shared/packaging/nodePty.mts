...
// children through, relative to the app root. Three places depend on
...
// executable bit (scripts/fix-node-pty-helper.mjs). A node-pty release
// that moves things is therefore a one-file change.
//
