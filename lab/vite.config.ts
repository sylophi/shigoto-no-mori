...
// Clerk. Mirrors the repo-root vite.web.config.ts (same plugins, same
// aliases) with three differences: the lab root, a distinct port, and
// the @clerk/* aliases onto the lab's in-memory stub so account UI
// renders signed-in without a network. Those shared pieces live in
